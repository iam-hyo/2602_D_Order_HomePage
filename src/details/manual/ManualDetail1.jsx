...
import Card1 from './Detail1/card1';
import Card2 from './Detail1/card2';
import Card3 from './Detail1/card3';
import Card4 from './Detail1/card4';
import CardGuide from './Detail3/cardGuide';

const SECTION_IDS = ['card1', 'card2', 'card3', 'card4', 'guide'];

/** 밀어서 결제 확인(Manual1) 전용: 스크롤 스냅 + 우측 인디케이터, 마지막에 CardGuide */
export default function ManualDetail1() {
