...
export default function CardGuide() {
  return (
    <section className="w-full max-w-6xl mx-auto px-6 md:px-12 tracking-tight lg:tracking-normal">
      ...
      <div className="flex flex-col md:flex-row gap-10 items-center rounded-[2.5rem] p-8 md:p-12 bg-[#F8FAFC] min-h-0">
        <motion.div
        ...
        <div className="flex-1 text-left min-w-0">
          <p className="text-[24px] text-gray-600 leading-relaxed mb-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center text-xl flex-shrink-0">
                →
              </span>
            </button>
            <button
          ...
          <button
            type="button"
            className="mt-8 w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-4 rounded-2xl text-[24px] transition-colors"
          >
            사용설명서 PDF 다운로드
          </button>
        </div>
